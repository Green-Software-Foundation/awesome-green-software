...
- [Green Software Foundation Directory](#green-software-foundation-directory)
  - [Features](#features)
...
- [Green Software Awesome List](#green-software-awesome-list)
  - [Contents](#contents)
...
- [CEEMS](https://ceems-dev.github.io/ceems/) (Compute Energy & Emissions Monitoring Stack) provides a complete performance, energy and emissions monitoring solution for SLURM (HPC), Openstack (VM) and Kubernetes (Container) workloads.
...
Please ensure your contributions align with our [Code of Conduct](code-of-conduct.md) and [Contributing Guidelines](contributing.md).
